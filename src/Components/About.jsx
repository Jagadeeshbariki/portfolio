 ...
 */
const description = "I have compleated the MCA in Sri Venkateswara University. I enjoy creating unique and simplistic user interfaces and Web sites in creative ways.";
